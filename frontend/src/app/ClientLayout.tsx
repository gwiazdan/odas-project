      ...
      <nav className="border-b border-gray-800 px-4 py-2.5 fixed left-0 right-0 top-0 z-50 bg-background">
              ...
              <div className="flex items-center justify-center md:hidden">
                ...
                >
                    <svg className='w-6 h-6 stroke-white' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M3 4H21"strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M3 12H21" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M3 20H21" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                </button>
              </div>
          ...
          <aside
            className={`fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform  duration-300 ease-in-out ${
              ...
              } sm:translate-x-0 border-r border-gray-800 md:translate-x-0 bg-background`}
            aria-label="Sidenav"
          >
